...
function Contact() {
  return (
    <div name='contact' className='text-white text-center font-medium'>
        <h2 className='text-2xl mt-12 mb-2'>Want to say hi?</h2>
        ...
        <div className='flex justify-center p-9'>
              ...
              <a className='text-sky-600 hover:text-sky-700 mb-4' href="https://twitter.com/OleAndresen_" target={'_blank'} rel="noreferrer"><AiOutlineTwitter className='text-2xl' /></a>
        </div>
    </div>
  )
}
