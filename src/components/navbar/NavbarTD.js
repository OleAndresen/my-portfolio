...
function NavbarTD() {
  ...
  return (
    <>
        ...
        <div className='md:hidden text-neutral-200 fixed right-10 top-10 z-50'>
        ...
        <div className={navbarOpen ? "showMenuNav" : "hidden"}>
            <nav className='md:hidden'>
                ...
                <div className='md:hidden'>
                    <button className='bg-neutral-200 text-black z-50 rounded-xl p-3 text-xl right-10 top-10 shadow-md'><BsSun /></button>
                    <a href='/' className='bg-neutral-200 text-black font-medium z-50 rounded-xl px-3 py-2.5 right-10 top-28 shadow-md cursor-pointer'>3D</a>
                </div>
            </nav>  
        </div>
    </>
